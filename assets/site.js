...
const translations = {
  index: {
    ja: {
      ...
      description: "CSVベースの結果整理、図表確認、レポート準備を落ち着いて進めるための macOS アプリです。",
      brandName: "{{appName}}",
      ...
      heroPoint1Body: "CSV の比較、図表確認、レポート前の整理。",
      ...
      summaryBody: "InsightDock は、CSV ベースの結果を見比べ、図表を確認し、レポート前の判断を整えやすくするための Mac アプリです。",
      summaryCard1Label: "Input",
      summaryCard1Title: "CSV や結果セットをまとめて見直しやすくする",
      summaryCard1Body: "複数のデータを読み込み、比較の起点をひとつの場所に整えます。",
      ...
      summaryCard3Body: "確認した内容を手元で整え、最終的なレポート作業につなげやすくします。",
      ...
      workflowBody: "入力から比較、レビュー、レポート準備までを、役割ごとに切り分けて扱える構成です。",
      workflowCard1Title: "Compare",
      workflowCard1Body: "対象データを並べて比較し、何を見比べるべきかを明確にします。",
      workflowCard2Title: "Review",
      workflowCard2Body: "図表とコンテキストを見ながら、解釈や確認メモを整理します。",
      workflowCard3Title: "Report",
      workflowCard3Body: "出力対象をまとめ、PDF 化や共有前の確認につなげます。",
      valueEyebrow: "Value",
      valueTitle: "プロダクトの核",
      ...
      trustCard1Body: "問い合わせ先、返信目安、FAQ、サポート範囲を確認できます。",
    ...
    en: {
      ...
      description: "InsightDock is a macOS app for organizing CSV-based results, comparing figures, and preparing reports with more clarity.",
      brandName: "{{appName}}",
      navOverview: "Overview",
      navSupport: "Support",
      navPrivacy: "Privacy",
      ...
      heroPoint1Body: "CSV comparison, figure checks, and report preparation.",
      ...
      summaryBody: "InsightDock helps organize CSV-based results, review figures, and prepare report-ready output with more clarity on Mac.",
      summaryCard1Label: "Input",
      summaryCard1Title: "Make CSV-based result sets easier to revisit",
      summaryCard1Body: "Bring multiple datasets into one place so comparison can start from a clearer baseline.",
      summaryCard2Label: "Review",
      ...
      summaryCard3Body: "Organize what needs to be checked first so the reporting step feels more deliberate.",
      audienceEyebrow: "Who it’s for",
      ...
      workflowBody: "Import, compare, review, and prepare output in a flow where each step has a clear role.",
      workflowCard1Title: "Compare",
      workflowCard1Body: "Line up the relevant datasets and decide what should be compared.",
      workflowCard2Title: "Review",
      workflowCard2Body: "Check figures and context together while capturing interpretation and review notes.",
      workflowCard3Title: "Report",
      workflowCard3Body: "Prepare the figures and comments that should be carried into export or sharing.",
      valueEyebrow: "Value",
      ...
      trustCard1Body: "Contact details, response expectations, FAQ, and support scope.",
      trustCard2Label: "Privacy",
  ...
  support: {
    ja: {
      ...
      callout:
        "InsightDock は、ログインを必要とせず、主要な比較・レビュー・PDF 出力機能をローカル環境で利用する前提で設計されています。",
      aside1Label: "Support Scope",
      aside1Title: "問い合わせ先がすぐ分かるページ構成",
      aside1Body:
    ...
    en: {
      ...
      callout:
        "InsightDock is built for local workflows and does not require account login for its core compare, review, and PDF export features.",
      aside1Label: "Support Scope",
      aside1Title: "Structured for clarity",
      aside1Body:
        "This page keeps contact details, response expectations, and FAQ visible without relying on buried documentation or account portals.",
      footer:
  ...
  privacy: {
    ja: {
      ...
      intro:
        "InsightDock（以下「本アプリ」）は、ユーザーのプライバシーを尊重し、主要なワークフローをユーザーの Mac 上で扱う前提で設計されています。",
      section1: "1. 連絡先情報",
      developer:
        "アプリ名: {{appName}}<br />お問い合わせ先: {{supportEmailLink}}",
      section2: "2. 通常利用時に扱う情報",
      normalUse:
        "本アプリは、通常の利用においてアカウント登録を必要としません。また、分析対象の CSV、画像、レポート本文、ノート内容を外部サーバーへ送信しない前提で設計されています。",
    ...
    en: {
      ...
      intro:
        "InsightDock (the “App”) respects your privacy and handles its core workflows locally on your Mac.",
